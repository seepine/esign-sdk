...
public class OrgAuthUrlReq extends Request {
  /** 业务方交互上下文信息 */
  ...
  @Override
  public void build() {
    setUrl("/v2/identity/auth/web/" + accountId + "/orgIdentityUrl");
